...
class FirebaseNotificationImp extends FirebaseNotification {
  FirebaseMessaging firebaseMessaging = FirebaseMessaging.instance;

  final String serverToken = "BDWq1eRj_gvke2r5AWNj8DuTSEHeSqqCLQXz4JLCcMwUNJGB7vkhGqdCqZzPCsggRsXJnIAezw0yZXnRjblPDV0";
