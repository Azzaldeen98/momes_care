...
abstract class CoursesRepository{
  ...
  Future<Either<Failure, List<CourseMedia>>> getCourseMedias(int courseId);
  ...
  Future<Either<Failure, Unit>> addCourseItem(CourseMedia courseMedia);
  Future<Either<Failure, Unit>> updateCourseItem(CourseMedia courseMedia);
