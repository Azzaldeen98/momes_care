...
class AddUpdateCourseItemPage extends StatefulWidget{

const AddUpdateCourseItemPage({super.key, this.courseItem,required this.course});
final CourseMedia? courseItem;
final Course course;

  @override
  State<AddUpdateCourseItemPage> createState() => _AddUpdateCourseItemPageState();
}
class _AddUpdateCourseItemPageState extends State<AddUpdateCourseItemPage>{
