      ...
      child: Container(
        ...
        child: Column(
              ...
              children: [
                      ...
                      showCupertinoModalPopup(context: context, builder: (BuildContext context) =>
                          DemoCWActionEditDeleteSheetScreen(
                            onEdited:(_context) async{
                              ...
                              Get.to(AddUpdateCommentPage(comment: comment, isUpdate: true));
                              ...
                              //     BlocProvider.of<PostBloc>(context).add(UpdateCommentEvent(post:_newPost));
                              //
                              ...
                              //   // Get.back();
                              // },baseContext: context,));
                              // // BlocProvider.of<PostBloc>(context).add(UpdateCommentEvent(post: post));
                              //  //
                            } ,
                            onDeleted: (_context) async{
                              // toasty(context, "onDeleted7777");
                              BlocProvider.of<AddDeleteUpdateCommentBloc>(context).add(DeleteCommentEvent( commentId: comment.id!));
                ...
                // HeaderWidget(author:comment!.author,onClickMoreOptions: (){
                //   showCupertinoModalPopup(context: context, builder: (BuildContext context) =>
                //       DemoCWActionEditDeleteSheetScreen(
                //         onEdited:(_context) async{
                //           // toasty(context, "onEdited7777");
                ...
                //         onDeleted: (_context) async{
                //           // toasty(context, "onDeleted7777");
                //           // BlocProvider.of<PostBloc>(context).add(DeleteCommentEvent(postId:post.id!));
                //           // MessageBox.showSuccess(context,  "onDeleted");
                //
                //           // toast("Accept Delete");
                //           // _showDeleteDialog(_context);
                ...
                FooterWidget(
                    onLiked:(){
                      // BlocProvider.of<PostBloc>(context).add((LikeUnLikeCommentEvent(postId:post.id!)));
                    },
                    onComments:(){
                    },
                    onReply:(){},
