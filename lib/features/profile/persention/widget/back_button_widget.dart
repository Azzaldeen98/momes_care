  ...
  return  Column(
    ...
    children: [
      ...
      CustomButton(
        ...
        raduis: 10,
        labelText:"Back".tr,
        icon: const Icon(Icons.arrow_back_ios_new,color: AppColor.secondaryIconColor,) ,
        bgColor:Colors.transparent,// AppColor.opacitybgCololr,
        textStyle: AppTextStyles.getBoldStyle(color: Colors.black26, fontSize:FontSizeManager.s18),
        onPressed:onPressed,
      ),
      Divider()
    ],
